// Package randompun provides a Go client for the Random Pun API.
//
// For more information, visit: https://apiverve.com/marketplace/randompun?utm_source=go&utm_medium=readme
package randompun
...
const (
	baseURL        = "https://api.apiverve.com/v1/randompun"
	defaultTimeout = 30 * time.Second
)

// Client is the Random Pun API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Random Pun API client.
...
// Execute makes a request to the Random Pun API.
