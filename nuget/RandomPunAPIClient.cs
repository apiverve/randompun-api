...
namespace APIVerve.API.RandomPun
{
    /// <summary>
    ...
    /// <summary>
    /// Client for the RandomPun API
    /// </summary>
    public class RandomPunAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/randompun";
        ...
        public RandomPunAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public RandomPunAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public RandomPunAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, RandomPunQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(RandomPunQueryOptions options)
        {
        ...
        public ResponseObj Execute(RandomPunQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(RandomPunQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(RandomPunQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(RandomPunQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(RandomPunQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(RandomPunQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(RandomPunQueryOptions options)
        {
